package com.irshad.EasyLocation.service;
...
import com.irshad.EasyLocation.permissionhelper.PermissionHelper;
import com.irshad.EasyLocation.utils.LocationUtils;
            ...
            public void onPermissionGranted() {
                new Thread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if (isSuccess) LogUtils.dTag("Location","init success");
                        Looper.loop();
                    }
                }).start();
            }
